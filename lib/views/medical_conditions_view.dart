...
class _MedicalConditionsViewState extends State<MedicalConditionsView> {
  ...
  Future<void> _openEditor({MedicalItem? existing, int? index}) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: ProfileAppBar(title: 'Medical Conditions'),
      body: Padding(
          ...
          child: _loading
              ...
              : Column(
                  children: [
                    ...
                    // Add button
                    Button(label: 'Add Condition / Allergy', onPressed: _openEditor),
                                  ...
                                  CupertinoListSection.insetGrouped(
                                    ...
                                    children: _items
                                        ...
                                        .map((it) {
                                          ...
                                          return Dismissible(
                                            key: ValueKey('${group['title']}-${it.name}'),
